...
const Checkout = () => {
  ...
  return (
    <div className="min-h-screen bg-[#F5F7FA] pt-[100px]">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-1">
            <div className="sticky top-24 space-y-6">
              <div className="bg-[#ffffff] border border-[#DDE5EE] rounded-xl p-6">
                    ...
                    cartItems.map((item) => (
                      <div key={item.id} className="flex gap-3">
                        <img
                          ...
                          alt={item.name}
                          loading="lazy"
                          className="w-16 h-16 rounded-lg object-cover border border-[#DDE5EE]"
                        />
                        <div className="flex-1">
                          <p className="text-[#222222] font-semibold text-sm">
                            {item.name}
                          </p>
                          <p className="text-[#007BFF]/70 text-xs">
                            Qty: {item.quantity}
                          </p>
                ...
                <div className="border-t border-[#DDE5EE] pt-4 space-y-3">
                  <div className="flex justify-between text-[#007BFF]/80">
                    <span>Subtotal</span>
                  ...
                  <div className="flex justify-between text-[#222222] font-bold text-lg mt-3 border-t border-[#DDE5EE] pt-3">
                    <span>Total</span>
