      ...
      <div className="min-h-screen bg-[#101010] flex items-center justify-center px-4">
        <div className="max-w-md w-full text-center space-y-6 animate-fade-in">
          ...
          <button
            ...
            className="w-full px-8 py-4 bg-[#D4AF37] text-[#101010] rounded-lg font-bold hover:bg-[#E8D7B5] transition-all duration-300 transform hover:scale-105 shadow-lg shadow-[#D4AF37]/30"
          >
            Continue Shopping
          </button>
        </div>
  ...
  return (
    <div className="min-h-screen bg-[#101010] flex items-center justify-center px-4 py-24">
      <div className="absolute inset-0 opacity-10">
        <div className="absolute top-1/4 left-1/4 h-96 bg-[#D4AF37] rounded-full blur-3xl animate-pulse"></div>
        <div
      ...
      <div className="max-w-6xl w-full relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
          ...
          <div className="hidden lg:block space-y-8 animate-fade-in">
            <div>
              <h1 className="text-5xl font-bold text-[#E8D7B5] mb-4">
                Welcome to
                <span className="block text-[#D4AF37]">PatchShop</span>
              </h1>
              <p className="text-[#D4AF37]/80 text-lg leading-relaxed">
          ...
          <div className="bg-[#1A1A1A] rounded-2xl border border-[#D4AF37]/20 p-6 sm:p-8 shadow-2xl animate-fade-in">
            {/* Toggle Tabs */}
            <div className="flex gap-2 mb-8 bg-[#101010] p-1 rounded-lg">
              <button
                ...
                className={`flex-1 py-3 px-4 rounded-lg font-semibold transition-all duration-300 ${
                  isLogin
                    ? "bg-[#D4AF37] text-[#101010] shadow-lg shadow-[#D4AF37]/30"
            ...
            {/* <div className="space-y-3 mb-6">
              <button className="w-full flex items-center justify-center gap-3 px-4 py-3 bg-[#101010] border border-[#D4AF37]/30 rounded-lg text-[#E8D7B5] font-semibold hover:border-[#D4AF37] hover:bg-[#D4AF37]/5 transition-all duration-300">
            ...
            <div className="flex items-center gap-4 mb-6">
              ...
              {/* <span className="text-[#D4AF37]/60 text-sm">OR</span> */}
              <div className="flex-1 h-px bg-[#D4AF37]/20"></div>
            </div>
            ...
            {isLogin ? (
              ...
              >
                <div>
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      className={`w-full pl-10 pr-4 py-3 bg-[#101010] border rounded-lg text-[#E8D7B5] placeholder-[#D4AF37]/50 focus:outline-none focus:border-[#D4AF37] transition-colors ${
                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      className={`w-full pl-10 pr-12 py-3 bg-[#101010] border rounded-lg text-[#E8D7B5] placeholder-[#D4AF37]/50 focus:outline-none focus:border-[#D4AF37] transition-colors ${
                        errors.password
                          ? "border-red-500"
                          : "border-[#D4AF37]/30"
                      }`}
                ...
                <div className="flex items-center justify-between pt-2">
                  <label className="flex items-center gap-2 cursor-pointer group">
                    <input
                      ...
                      className="w-4 h-4 bg-[#101010] border border-[#D4AF37]/30 rounded cursor-pointer"
                    />
                ...
                <button
                  type="submit"
                  disabled={isPending}
                  className={`w-full px-8 py-4 bg-[#D4AF37] text-[#101010] rounded-lg font-bold
                             hover:bg-[#E8D7B5] transition-all duration-300 transform hover:scale-105
                             active:scale-95 shadow-lg shadow-[#D4AF37]/30
              ...
              >
                ...
                <button
                  ...
                  className={`w-full px-8 py-4 bg-[#D4AF37] text-[#101010] rounded-lg font-bold hover:bg-[#E8D7B5] transition-all duration-300 transform hover:scale-105 active:scale-95 shadow-lg shadow-[#D4AF37]/30 flex items-center justify-center gap-2 mt-6
                ...
                <p className="text-[#D4AF37]/70 text-xs text-center mt-4">
